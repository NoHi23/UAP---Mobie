...
public interface SOService {
    ...
    Call<LecturerScheduleResponse> getLecturerSchedules(@Body GetLectureScheduleRequest body);
    ...
    Call<SupportRequestListResponse> getSupportRequests();

    @POST("lecturer/supports")
    Call<BasicResponse> createSupportRequest(@Body CreateSupportRequest body);
